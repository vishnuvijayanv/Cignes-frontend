  ...
  return (
    <div className="container ">
        <div className='border rounded shadow '  >
            <h1 className='text-center'>Student Registeration Form</h1>
            <hr />
        
           <Form onSubmit={studentRegister}  >
                <Row className='bg-light'>
                    <Col md={6} className='p-5'>
                        <label className=' mb-2' htmlFor="student_Name">Student Name :
                        </label>
                        ...
                        <label className='d-flex mb-2' htmlFor="phone">Phone :
                        </label>
                        <input  type="number"  id='phone' placeholder='Enter Phone Number' required className='form-control mb-3' onChange={(e)=>setStudentDetails({...StudentDetails,phone:e.target.value})} />

                        <label className='d-flex mb-2' htmlFor="email">Email:
                        </label>
                        ...
                        <Multiselect
                           ...
                           <div className='d-flex mt-4'>
                            <h6 className='me-4'>Course Mode:</h6>    
                            {['checkbox'].map((type) => (
                    ...
                    <Form.Group className="mb-3">
                        <label className='d-flex flex-column mb-2 me-2 mt-3' htmlFor="dob">Date of Birth :</label>
                    ...
                    <Form.Group controlId="formFileLg" className="mb-3">
                        <Form.Label>Upload Your Student Id (Both Sides)</Form.Label>
                        <Form.Control type="file" multiple size="lg" onChange={(e)=>setStudentDetails({...StudentDetails,idImages:e.target.files})} />
                    </Form.Group>
                    ...
                    <button onClick={(e)=>studentRegister(e)} type='submit' className='form-control btn btn-success mt-3'>Submit</button>
                    <button onClick={handleClear} type='submit' className='form-control btn btn-light mt-3'>Clear</button>
